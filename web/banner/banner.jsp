...
<div class="shutter">
    <div class="shutter-img">
        <a href="#" data-shutter-title="小米Nova2双曲面商务旗舰"><img src="<%=request.getContextPath()%>/image/login_bg.jpg" alt="#"></a>
        <a href="#" data-shutter-title="小米Mix"><img src="<%=request.getContextPath()%>/image/banner.jpg" alt="#"></a>
        <a href="#" data-shutter-title="小米6 变焦双摄，拍人更美"><img src="<%=request.getContextPath()%>/image/banner2.jpg" alt="#"></a>
        <a href="#" data-shutter-title="让每一次出游变成一种期待"><img src="<%=request.getContextPath()%>/image/pinghengche.jpg" alt="#"></a>
    </div>
